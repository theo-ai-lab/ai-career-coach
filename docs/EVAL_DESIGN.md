...
> - **Current in-app eval judge** — `gpt-4o-mini` (temperature 0): the LLM-as-judge this document describes; it scored the pilot's responses (also the judge behind the May 2026 red-team run).
